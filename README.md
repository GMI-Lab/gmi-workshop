...
## 1.- Introducción
Bienvenidos al repositorio de nuestro taller de Bioinformatica, a continuación ustedes van a recibir una serie de protocolos para la ejecución de ciertas funciones en base a líneas de comandos y las instrucciones respectivas.
